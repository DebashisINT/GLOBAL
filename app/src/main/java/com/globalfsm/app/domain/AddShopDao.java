...
import static com.globalfsm.app.AppConstant.SHOP_TABLE;

import com.globalfsm.features.marketAssist.ChurnShopL;
import com.globalfsm.features.marketAssist.ShopDtls;
import com.globalfsm.features.marketAssist.ShopLastVisit;
import com.globalfsm.features.performanceAPP.NoOrderTakenList;
import com.globalfsm.features.performanceAPP.ShopDtlsCustom;
...
//    void insertOrUpdateShop(long id, String title, String url);
    ...
    @Query("Select * from shop_detail where type=:type and assigned_to_dd_id=:assigned_to_dd_id and shop_name=:shop_name")
