package com.globalfsm.features.addshop.presentation
...
import com.globalfsm.features.NewQuotation.AddQuotFormFragment
...
import com.globalfsm.features.dashboard.presentation.ShopVerificationDialog
import com.globalfsm.features.dashboard.presentation.VisitRemarksTypeAdapter
...
import com.globalfsm.features.location.model.ShopDurationRequestData
...
import com.globalfsm.features.login.model.GetQtsAnsSubmitDtlsResponseModel
...
import com.globalfsm.features.photoReg.PhotoRegAadhaarFragment
import com.globalfsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.globalfsm.features.viewAllOrder.interf.QaOnCLick
import com.globalfsm.features.viewAllOrder.orderOptimized.CustomProductRate
...
//        }
        ...
        if(checkNearbyDuplicacy(shopLat,shopLong) && false){
            val simpleDialog = Dialog(mContext)
...
//        popup.showAtLocation(layout , Gravity.CENTER, 0, 0);
    ...
    fun checkNearbyDuplicacy(shopLat: Double, shopLong: Double):Boolean{
        ...
        var shopN = shopName.text.toString()
        var selDDid = assignedToDDId
        var shopType1L: ArrayList<AddShopDBModelEntity> = AppDatabase.getDBInstance()!!.addShopEntryDao().getShopsAccordingToTypeDD("1",selDDid,shopN) as ArrayList<AddShopDBModelEntity>
        if(shopType1L.size>0){
            for(i in 0..shopType1L.size-1){
                ...
                if(obj.shopName.equals(shopN) && isShopNearby){
