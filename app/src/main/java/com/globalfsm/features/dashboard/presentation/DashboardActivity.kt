package com.globalfsm.features.dashboard.presentation
...
import com.globalfsm.*
import com.globalfsm.R
import com.globalfsm.app.*
import com.globalfsm.app.NewFileUtils.browseDocuments
import com.globalfsm.app.NewFileUtils.getExtension
import com.globalfsm.app.domain.*
import com.globalfsm.app.types.DashboardType
import com.globalfsm.app.types.FragType
import com.globalfsm.app.types.TopBarConfig
import com.globalfsm.app.uiaction.DisplayAlert
import com.globalfsm.app.utils.*
import com.globalfsm.app.utils.AppUtils.Companion.isProfile
import com.globalfsm.base.BaseResponse
import com.globalfsm.base.presentation.BaseActivity
import com.globalfsm.base.presentation.BaseFragment
import com.globalfsm.features.NewQuotation.*
import com.globalfsm.features.NewQuotation.api.GetQuotRegProvider
import com.globalfsm.features.NewQuotation.model.ViewDetailsQuotResponse
import com.globalfsm.features.SearchLocation.SearchLocationFragment
import com.globalfsm.features.SearchLocation.locationInfoModel
import com.globalfsm.features.TA.ViewAllTAListFragment
import com.globalfsm.features.achievement.AchievementFragment
import com.globalfsm.features.activities.presentation.*
import com.globalfsm.features.addAttendence.*
import com.globalfsm.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.globalfsm.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.globalfsm.features.addAttendence.model.GetReportToFCMResponse
import com.globalfsm.features.addAttendence.model.GetReportToResponse
import com.globalfsm.features.addAttendence.model.Leave_list_Response
import com.globalfsm.features.addorder.presentation.AddOrderFragment
...
import com.globalfsm.features.addshop.presentation.AddShopFragment
import com.globalfsm.features.addshop.presentation.OTPVerificationDialog
import com.globalfsm.features.addshop.presentation.ScanImageFragment
import com.globalfsm.features.addshop.presentation.ShowCardDetailsDialog
import com.globalfsm.features.alarm.model.AlarmData
import com.globalfsm.features.alarm.presetation.AttendanceReportFragment
import com.globalfsm.features.alarm.presetation.PerformanceReportFragment
import com.globalfsm.features.alarm.presetation.VisitReportDetailsFragment
import com.globalfsm.features.alarm.presetation.VisitReportFragment
import com.globalfsm.features.attendance.AttendanceFragment
import com.globalfsm.features.attendance.api.AttendanceRepositoryProvider
...
import com.globalfsm.features.averageshop.presentation.AverageShopFragment
import com.globalfsm.features.avgorder.presentation.AverageOrderFragment
import com.globalfsm.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.globalfsm.features.beatCustom.TeamBeatListFragment
import com.globalfsm.features.billing.presentation.AddBillingFragment
import com.globalfsm.features.billing.presentation.BillingDetailsFragment
import com.globalfsm.features.billing.presentation.BillingListFragment
import com.globalfsm.features.changepassword.presentation.ChangePasswordDialog
import com.globalfsm.features.chat.model.ChatListDataModel
import com.globalfsm.features.chat.model.ChatUserDataModel
import com.globalfsm.features.chat.model.GroupUserDataModel
import com.globalfsm.features.chat.presentation.*
import com.globalfsm.features.chatbot.presentation.ChatBotFragment
import com.globalfsm.features.chatbot.presentation.ChatBotShopListFragment
import com.globalfsm.features.chatbot.presentation.ReportsFragment
import com.globalfsm.features.chatbot.presentation.SelectLanguageDialog
import com.globalfsm.features.commondialog.presentation.CommonDialog
import com.globalfsm.features.commondialog.presentation.CommonDialogClickListener
import com.globalfsm.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.globalfsm.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.globalfsm.features.commondialogsinglebtn.OnDialogClickListener
import com.globalfsm.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.globalfsm.features.dailyPlan.prsentation.AllShopListFragment
import com.globalfsm.features.dailyPlan.prsentation.DailyPlanListFragment
import com.globalfsm.features.dailyPlan.prsentation.PlanDetailsFragment
import com.globalfsm.features.damageProduct.ShopDamageProductListFrag
import com.globalfsm.features.damageProduct.ShopDamageProductSubmitFrag
import com.globalfsm.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.globalfsm.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.globalfsm.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.globalfsm.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.globalfsm.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.globalfsm.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.globalfsm.features.dashboard.presentation.model.ContentListResponseModel
import com.globalfsm.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.globalfsm.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.globalfsm.features.device_info.presentation.DeviceInfoListFragment
import com.globalfsm.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.globalfsm.features.document.DocumentRepoFeatureNewFragment
import com.globalfsm.features.document.presentation.DocumentListFragment
import com.globalfsm.features.document.presentation.DocumentTypeListFragment
import com.globalfsm.features.document.presentation.OpenFileWebViewFragment
import com.globalfsm.features.dymanicSection.presentation.AddDynamicFragment
import com.globalfsm.features.dymanicSection.presentation.AllDynamicListFragment
import com.globalfsm.features.dymanicSection.presentation.DynamicListFragment
import com.globalfsm.features.dymanicSection.presentation.EditDynamicFragment
import com.globalfsm.features.gpsDisabilityScreen.GpsDisableFragment
import com.globalfsm.features.home.presentation.HomeFragment
import com.globalfsm.features.homelocation.presentation.HomeLocationFragment
import com.globalfsm.features.homelocation.presentation.HomeLocationMapFragment
import com.globalfsm.features.know_your_state.KnowYourStateFragment
import com.globalfsm.features.lead.LeadFrag
import com.globalfsm.features.lead.ViewLeadFrag
import com.globalfsm.features.leaveapplynew.LeaveHome
import com.globalfsm.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.globalfsm.features.localshops.LocalShopListFragment
import com.globalfsm.features.localshops.LocalShopListMapFragment
import com.globalfsm.features.localshops.NearByShopsMapFragment
import com.globalfsm.features.location.*
import com.globalfsm.features.location.api.LocationRepoProvider
import com.globalfsm.features.location.model.*
import com.globalfsm.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.globalfsm.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.globalfsm.features.login.ShopFeedbackEntity
import com.globalfsm.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.globalfsm.features.login.presentation.LoginActivity
import com.globalfsm.features.logout.presentation.api.LogoutRepositoryProvider
import com.globalfsm.features.logoutsync.presentation.LogoutSyncFragment
import com.globalfsm.features.marketing.presentation.MarketingPagerFragment
import com.globalfsm.features.meetinglist.prsentation.MeetingListFragment
import com.globalfsm.features.member.MapViewForTeamFrag
import com.globalfsm.features.member.model.TeamLocDataModel
import com.globalfsm.features.member.model.TeamShopListDataModel
import com.globalfsm.features.member.presentation.*
import com.globalfsm.features.menuBeat.MenuBeatFrag
import com.globalfsm.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.globalfsm.features.micro_learning.presentation.MicroLearningListFragment
import com.globalfsm.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.globalfsm.features.myallowancerequest.MyallowanceRequestFragment
import com.globalfsm.features.myjobs.model.CustomerDataModel
import com.globalfsm.features.myjobs.presentation.*
import com.globalfsm.features.myorder.presentation.MyOrderListFragment
import com.globalfsm.features.myprofile.presentation.MyProfileFragment
import com.globalfsm.features.nearbyshops.api.ShopListRepositoryProvider
import com.globalfsm.features.nearbyshops.model.ShopData
import com.globalfsm.features.nearbyshops.model.ShopListResponse
import com.globalfsm.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.globalfsm.features.nearbyshops.presentation.BeatListFragment
import com.globalfsm.features.nearbyshops.presentation.NearByShopsListFragment
import com.globalfsm.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.globalfsm.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.globalfsm.features.newcollection.CollectionDetailsStatusFragment
import com.globalfsm.features.newcollection.CollectionShopListFragment
import com.globalfsm.features.newcollection.NewCollectionListFragment
import com.globalfsm.features.newcollectionreport.*
import com.globalfsm.features.notification.NotificationFragment
import com.globalfsm.features.orderList.NewDateWiseOrderListFragment
import com.globalfsm.features.orderList.NewOrderListFragment
import com.globalfsm.features.orderList.OrderListFragment
import com.globalfsm.features.orderdetail.presentation.OrderDetailFragment
import com.globalfsm.features.orderhistory.ActivityMapFragment
import com.globalfsm.features.orderhistory.OrderhistoryFragment
import com.globalfsm.features.orderhistory.TimeLineFragment
import com.globalfsm.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.globalfsm.features.orderhistory.model.FetchLocationRequest
import com.globalfsm.features.orderhistory.model.FetchLocationResponse
import com.globalfsm.features.orderhistory.model.LocationData
import com.globalfsm.features.pendinglocationinout.PendingOutLocationFrag
import com.globalfsm.features.performance.GpsStatusFragment
import com.globalfsm.features.performance.PerformanceFragment
import com.globalfsm.features.performance.api.UpdateGpsStatusRepoProvider
import com.globalfsm.features.performance.model.UpdateGpsInputParamsModel
import com.globalfsm.features.performanceAPP.PerformanceAppFragment
import com.globalfsm.features.permissionList.ViewPermissionFragment
import com.globalfsm.features.photoReg.*
import com.globalfsm.features.privacypolicy.PrivacypolicyWebviewFrag
import com.globalfsm.features.quotation.presentation.*
import com.globalfsm.features.reimbursement.presentation.*
import com.globalfsm.features.report.presentation.*
import com.globalfsm.features.returnsOrder.*
import com.globalfsm.features.settings.presentation.SettingsFragment
import com.globalfsm.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.globalfsm.features.shopdetail.presentation.*
import com.globalfsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.globalfsm.features.stock.StockDetailsFragment
import com.globalfsm.features.stock.StockListFragment
import com.globalfsm.features.stockAddCurrentStock.AddShopStockFragment
import com.globalfsm.features.stockAddCurrentStock.UpdateShopStockFragment
import com.globalfsm.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.globalfsm.features.stockCompetetorStock.AddCompetetorStockFragment
import com.globalfsm.features.stockCompetetorStock.CompetetorStockFragment
import com.globalfsm.features.stockCompetetorStock.ViewComStockProductDetails
import com.globalfsm.features.survey.SurveyFrag
import com.globalfsm.features.survey.SurveyViewDtlsFrag
import com.globalfsm.features.survey.SurveyViewFrag
import com.globalfsm.features.task.presentation.AddTaskFragment
import com.globalfsm.features.task.presentation.CalenderTaskFragment
import com.globalfsm.features.task.presentation.EditTaskFragment
import com.globalfsm.features.task.presentation.TaskListFragment
import com.globalfsm.features.taskManagement.TaskManagementFrag
import com.globalfsm.features.taskManagement.ViewTaskManagementFrag
import com.globalfsm.features.timesheet.presentation.AddTimeSheetFragment
import com.globalfsm.features.timesheet.presentation.EditTimeSheetFragment
import com.globalfsm.features.timesheet.presentation.TimeSheetListFragment
import com.globalfsm.features.viewAllOrder.CartFragment
import com.globalfsm.features.viewAllOrder.OrderTypeListFragment
import com.globalfsm.features.viewAllOrder.ViewAllOrderListFragment
import com.globalfsm.features.viewAllOrder.ViewCartFragment
import com.globalfsm.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.globalfsm.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.globalfsm.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.globalfsm.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.globalfsm.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.globalfsm.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.globalfsm.features.viewPPDDStock.ViewOutstandingFragment
import com.globalfsm.features.viewPPDDStock.ViewPPDDListFragment
import com.globalfsm.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.globalfsm.features.viewPPDDStock.ViewStockFragment
import com.globalfsm.features.weather.presentation.WeatherFragment
import com.globalfsm.mappackage.MapActivity
import com.globalfsm.mappackage.MapActivityWithoutPath
import com.globalfsm.mappackage.SendBrod
import com.globalfsm.widgets.AppCustomEditText
import com.globalfsm.widgets.AppCustomTextView
...
import com.globalfsm.app.NewFileUtils.browsePDFDocuments
import com.globalfsm.features.marketAssist.MarketAssistTabFrag
import com.globalfsm.features.marketAssist.ShopDtlsMarketAssistFrag
import com.globalfsm.features.marketAssist.ShopListMarketAssistFrag
import com.globalfsm.features.performanceAPP.OwnPerformanceFragment
import com.globalfsm.features.performanceAPP.allPerformanceFrag
import com.globalfsm.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xglobalfsmlogsample/log").path);
            //27-09-2021
//            val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xglobalfsmlogsample/log").path);
...
//                BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath="/data/user/0/com.globalfsm/files/Fsmlog.html"
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xglobalfsmlogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xglobalfsmlogsample/log.bak.1").path);
...
//        return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root =  File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xglobalfsmlogsample/log" + ".txt")
            if (!root.exists()) {
                root.mkdirs()
            }
...
//        }
        val bytes = ByteArrayOutputStream()
//        bm!!.compress(Bitmap.CompressFormat.JPEG, 90, bytes)
        var destination = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xglobalfsmlogsample/log")
        val fo: FileOutputStream
        val fo1:FileWriter
        try {
            fo = FileOutputStream(destination)
