package com.globalfsm.features.logoutsync.presentation
...
import com.globalfsm.CustomConstants


import com.globalfsm.R
import com.globalfsm.app.AppDatabase
...
import com.globalfsm.app.utils.Toaster
import com.globalfsm.base.BaseResponse
import com.globalfsm.base.presentation.BaseActivity
import com.globalfsm.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.globalfsm.features.billing.api.AddBillingRepoProvider
import com.globalfsm.features.billing.model.AddBillingInputParamsModel
...
import com.globalfsm.features.dashboard.presentation.ReasonDialog
...
import com.globalfsm.features.document.model.AddEditDocumentInputParams
import com.globalfsm.features.document.model.DocumentAttachmentModel
...
import com.globalfsm.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
...
import com.globalfsm.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.globalfsm.features.orderhistory.model.*
...
import com.globalfsm.features.quotation.model.AddQuotInputModel
import com.globalfsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.globalfsm.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.globalfsm.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.globalfsm.features.stockAddCurrentStock.ShopAddCurrentStockList
import com.globalfsm.features.stockAddCurrentStock.ShopAddCurrentStockRequest
import com.globalfsm.features.stockAddCurrentStock.api.ShopAddStockProvider
import com.globalfsm.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.globalfsm.features.timesheet.model.AddTimeSheetInputModel
import com.globalfsm.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.globalfsm.features.viewAllOrder.model.AddOrderInputParamsModel
import com.globalfsm.features.viewAllOrder.model.AddOrderInputProductList
import com.globalfsm.mappackage.SendBrod
import com.globalfsm.widgets.AppCustomTextView
import com.globalfsm.MonitorService
import com.globalfsm.MySingleton
import com.globalfsm.features.addshop.model.*
import com.globalfsm.features.addshop.model.assigntopplist.AddShopUploadImg
import com.globalfsm.features.addshop.presentation.ShopExtraContactReq
...
import com.globalfsm.features.login.model.GetConcurrentUserResponse
import com.globalfsm.features.login.model.WhatsappApiData
import com.globalfsm.features.performance.model.Gps_status_list
import com.globalfsm.features.performance.model.UpdateGpsInputListParamsModel
import com.globalfsm.features.returnsOrder.ReturnProductList
import com.globalfsm.features.returnsOrder.ReturnRequest
import com.globalfsm.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xglobalfsmlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xglobalfsmlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xglobalfsmlogsample/log.zip").path);
